...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/backports.zoneinfo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/backports.zoneinfo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11016&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/backports.zoneinfo-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add backports.zoneinfo
# for installing globally
pixi global install backports.zoneinfo
```
...
It is possible to list all of the versions of `backports.zoneinfo` available on your platform:
...
```
pixi search backports.zoneinfo --channel conda-forge
```
